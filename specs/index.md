...
| 0004 | [Hook Protocol Specification](./0004-hook-protocol-spec.md) | 13 种 Agent Hook 协议完整规范 | ✅ |
...
| 0011 | [MCP Server](./0011-mcp-server.md) | MCP JSON-RPC Server 集成：7 个 Tool | ✅ 已实现 |
| 0012 | [Format Router](./0012-format-router.md) | 智能格式路由：结构分析 + 3 种编码策略 | ✅ 已实现 |
| 0013 | [Differential Response](./0013-differential-response.md) | 差分响应压缩：轮询场景 unified diff | ✅ 已完成 |
| 0014 | [Semantic-Aware Compression](./0014-semantic-aware-compression.md) | 语义感知压缩：三级架构（规则→ONNX→远程 API） | ✅ Level 1 已实现 |
| 0015 | [Security Hardening](./0015-security-hardening.md) | 安全加固：9 项安全配置缺口修复 | ✅ 已完成 |
| 0016 | [Architecture Alignment](./0016-architecture-alignment.md) | 架构对齐：workspace 重组、lint 严格化、CLI 模块化、测试基础设施 | ✅ 已完成 |
| 0017 | [Stats History Management](./0017-stats-management.md) | 统计数据历史管理：删除、导出、VACUUM | ✅ 已实现 |
| 0018 | [Compression Stats Reporting](./0018-compression-stats-reporting.md) | agent-proxy → tokenless 请求完成回传协议 | ✅ 已实现 |
| 0019 | [Async Semantic Provider](./0019-async-semantic-provider.md) | Level 3 远程 embedding API + 异步 provider trait 抽象 | 📝 Spec 完成 |
| 0020 | [Team Savings Dashboard](./0020-team-dashboard.md) | 团队成本控制台：多维度节省分析、预算预警、分阶段商业化 | 📝 Spec 完成 |
| 0021 | [Policy Config Center](./0021-policy-config-center.md) | 策略配置中心：按作用域与工具类型管理压缩策略 | 📝 Spec 完成 |
| — | [Codex CLI Support](./codex-support-spec.md) | OpenAI Codex CLI 集成：AGENTS.md + RTK.md 规则文件 | ✅ 已实现 |
